...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_services_icon" AS ENUM('Building2', 'Landmark', 'Calculator', 'FileText', 'Shield');
  CREATE TYPE "public"."enum_stats_icon" AS ENUM('Users', 'Award', 'Shield', 'Clock', 'Star');
  ...
  CREATE TABLE "services" (
  	...
  	"icon" "enum_services_icon" DEFAULT 'FileText',
  	"image_id" integer,
  ...
  CREATE TABLE "stats" (
  	...
  	"icon" "enum_stats_icon" DEFAULT 'Star',
  	"order" numeric DEFAULT 0,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  ALTER TABLE "stats" ADD CONSTRAINT "stats_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "client_photos" ADD CONSTRAINT "client_photos_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "client_photos" ADD CONSTRAINT "client_photos_photo_id_media_id_fk" FOREIGN KEY ("photo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_client_photos_fk" FOREIGN KEY ("client_photos_id") REFERENCES "public"."client_photos"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "stats_site_idx" ON "stats" USING btree ("site_id");
  ...
  CREATE INDEX "client_photos_site_idx" ON "client_photos" USING btree ("site_id");
  CREATE INDEX "client_photos_photo_idx" ON "client_photos" USING btree ("photo_id");
  CREATE INDEX "client_photos_updated_at_idx" ON "client_photos" USING btree ("updated_at");
  CREATE INDEX "client_photos_created_at_idx" ON "client_photos" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_client_photos_id_idx" ON "payload_locked_documents_rels" USING btree ("client_photos_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "client_photos" CASCADE;
